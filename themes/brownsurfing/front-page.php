    ...
    echo '<section class="position-relative" style="padding:100px 0;">';
        echo '<div class="container">';
            echo '<div class="row align-items-center">';
                ...
                echo 'Developer</h1>';
                echo '<h2 class="h5">Do you want to build a website successfully?</h2>';
                echo '<p>Proficient in HTML, CSS, JavaScript, and PHP with years of experience creating stunning and functional websites in a variety of industries.</p>';
                echo '<a href="' . home_url() . '/contact/" target="_self" class="btn btn-lg bg-accent-gradient text-white">Start building websites successfully <svg style="width:15px;" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Free 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. --><path d="M334.5 414c8.8 3.8 19 2 26-4.6l144-136c4.8-4.5 7.5-10.8 7.5-17.4s-2.7-12.9-7.5-17.4l-144-136c-7-6.6-17.2-8.4-26-4.6s-14.5 12.5-14.5 22l0 88L32 208c-17.7 0-32 14.3-32 32l0 32c0 17.7 14.3 32 32 32l288 0 0 88c0 9.6 5.7 18.2 14.5 22z"/></svg></a>';
                echo '</div>';

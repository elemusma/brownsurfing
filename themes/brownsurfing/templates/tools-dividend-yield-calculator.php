 ...
 */
 ...
 echo '<input type="number" name="initial-amount" id="initialAmount">';
 echo '</div>';
...
echo '<div class="col-lg-4 col-md-6">';
 ...
 echo '<input type="number" name="stock-price" id="stockPrice">';
 echo '</div>';
 echo '</div>';
 ...
 echo '<input type="number" name="annual-earnings-reinvest" id="">';
 echo '</div>';

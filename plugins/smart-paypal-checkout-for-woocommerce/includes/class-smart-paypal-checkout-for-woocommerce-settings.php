        ...
        public function psb_setting_fields() {
            ...
            $button_manager_settings = array(
                ...
                'product_button_settings' => array(
                    ...
                    'class' => '',
                    'description' => __('Enable the Product specific button settings, and the options set will be applied to the PayPal Smart buttons on your Product pages.', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'title',
                    'class' => '',
                ),
                'enable_product_button' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Smart Button on the Product Pages.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    'description' => __('', 'smart-paypal-checkout-for-woocommerce'),
                ),
                'product_disallowed_funding_methods' => array(
                    'title' => __('Hide Funding Method(s)', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'multiselect',
                    'class' => 'wc-enhanced-select psb_product_button_settings',
                    'description' => __('Funding methods selected here will be hidden from buyers during checkout.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => array(
                        'card' => __('Credit or Debit Card', 'smart-paypal-checkout-for-woocommerce'),
                        'credit' => __('PayPal Credit', 'smart-paypal-checkout-for-woocommerce'),
                        'paylater' => __('Pay Later', 'smart-paypal-checkout-for-woocommerce'),
                        'bancontact' => __('Bancontact', 'smart-paypal-checkout-for-woocommerce'),
                        'blik' => __('BLIK', 'smart-paypal-checkout-for-woocommerce'),
                        ...
                        'mercadopago' => __('Mercado Pago', 'smart-paypal-checkout-for-woocommerce'),
                ...
                'product_button_layout' => array(
                    'title' => __('Button Layout', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select psb_product_button_settings',
                    'description' => __('Select Vertical for stacked buttons, and Horizontal for side-by-side buttons.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => 'horizontal',
                    'desc_tip' => true,
                    'options' => array(
                        'horizontal' => __('Horizontal (Recommended)', 'smart-paypal-checkout-for-woocommerce'),
                        'vertical' => __('Vertical', 'smart-paypal-checkout-for-woocommerce')
                    ),
                ),
                ...
                'product_button_label' => array(
                    ...
                    'options' => array(
                        ...
                        'buynow' => __('Buy Now', 'smart-paypal-checkout-for-woocommerce'),
                        'pay' => __('Pay', 'smart-paypal-checkout-for-woocommerce'),
                    ),
                ),
                'product_button_tagline' => array(
                    'title' => __('Tagline', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'checkbox',
                    'class' => 'psb_product_button_settings',
                    'default' => 'yes',
                    'label' => __('Enable tagline', 'smart-paypal-checkout-for-woocommerce'),
                    'desc_tip' => true,
                    'description' => __(
                            'Add the tagline. This line will only show up, if you select a horizontal layout.', 'smart-paypal-checkout-for-woocommerce'
                    ),
                ),
                'cart_button_settings' => array(
                    'title' => __('Cart Page', 'smart-paypal-checkout-for-woocommerce'),
                    'class' => '',
                    'description' => __('Enable the Cart specific button settings, and the options set will be applied to the PayPal buttons on your Cart page.', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'title',
                    'class' => '',
                ),
                'enable_cart_button' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Smart Button on the Cart page.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    'description' => __('Optionally override global button settings above and configure buttons specific to Cart page.', 'smart-paypal-checkout-for-woocommerce'),
                ),
                'cart_disallowed_funding_methods' => array(
                    'title' => __('Hide Funding Method(s)', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'multiselect',
                    'class' => 'wc-enhanced-select psb_cart_button_settings',
                    'description' => __('Funding methods selected here will be hidden from buyers during checkout.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => array(
                ...
                'cart_button_layout' => array(
                    ...
                    'desc_tip' => true,
                    'options' => array(
                        'vertical' => __('Vertical (Recommended)', 'smart-paypal-checkout-for-woocommerce'),
                        'horizontal' => __('Horizontal', 'smart-paypal-checkout-for-woocommerce'),
                    ),
                ),
                ...
                'cart_button_tagline' => array(
                    'title' => __('Tagline', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'checkbox',
                    'class' => 'psb_cart_button_settings',
                    'default' => 'yes',
                    'label' => __('Enable tagline', 'smart-paypal-checkout-for-woocommerce'),
                    'desc_tip' => true,
                    'description' => __(
                ...
                'checkout_button_settings' => array(
                    'title' => __('Checkout Page', 'smart-paypal-checkout-for-woocommerce'),
                    'class' => '',
                    'description' => __('Enable the checkout specific button settings, and the options set will be applied to the PayPal buttons on your checkout page.', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'title',
                    'class' => '',
                ),
                'enable_checkout_button' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Smart Button on the Checkout page.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    'description' => __('Optionally override global button settings above and configure buttons specific to checkout page.', 'smart-paypal-checkout-for-woocommerce'),
                ),
                'checkout_disallowed_funding_methods' => array(
                    'title' => __('Hide Funding Method(s)', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'multiselect',
                    'class' => 'wc-enhanced-select psb_checkout_button_settings',
                    'description' => __('Funding methods selected here will be hidden from buyers during checkout.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => array(
                ...
                'checkout_button_label' => array(
                    ...
                    'desc_tip' => true,
                    'options' => array(
                        'paypal' => __('PayPal', 'smart-paypal-checkout-for-woocommerce'),
                        'checkout' => __('Checkout', 'smart-paypal-checkout-for-woocommerce'),
                        'buynow' => __('Buy Now', 'smart-paypal-checkout-for-woocommerce'),
                        'pay' => __('Pay', 'smart-paypal-checkout-for-woocommerce'),
                    ),
                ...
                'checkout_button_tagline' => array(
                    'title' => __('Tagline', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'checkbox',
                    'class' => 'psb_checkout_button_settings',
                    'default' => 'yes',
                    'label' => __('Enable tagline', 'smart-paypal-checkout-for-woocommerce'),
                    'desc_tip' => true,
                    'description' => __(
                ...
                'mini_cart_button_settings' => array(
                    'title' => __('Mini Cart Page', 'smart-paypal-checkout-for-woocommerce'),
                    'class' => '',
                    'description' => __('Enable the Mini Cart specific button settings, and the options set will be applied to the PayPal buttons on your Mini Cart page.', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'title',
                    'class' => '',
                ),
                'enable_mini_cart_button' => array(
                    ...
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Smart Button on the Mini Cart page.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    'description' => __('Optionally override global button settings above and configure buttons specific to Mini Cart page.', 'smart-paypal-checkout-for-woocommerce'),
                ),
                'mini_cart_disallowed_funding_methods' => array(
                    'title' => __('Hide Funding Method(s)', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'multiselect',
                    'class' => 'wc-enhanced-select psb_mini_cart_button_settings',
                    'description' => __('Funding methods selected here will be hidden from buyers during checkout.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
                    'options' => array(
                ...
                'mini_cart_button_tagline' => array(
                    'title' => __('Tagline', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'checkbox',
                    'class' => 'psb_mini_cart_button_settings',
                    'default' => 'yes',
                    'label' => __('Enable tagline', 'smart-paypal-checkout-for-woocommerce'),
                    'desc_tip' => true,
                    'description' => __(
            ...
            $pay_later_messaging_settings = array(
                ...
                'pay_later_messaging_home_preview_shortcode' => array(
                    ...
                    'default' => '[psb_bnpl_message placement="home"]'
                ),
                ...
                'pay_later_messaging_category_preview_shortcode' => array(
                    ...
                    'custom_attributes' => array('readonly' => 'readonly'),
                    'default' => '[psb_bnpl_message placement="category"]'
                ),
                ...
                'pay_later_messaging_product_preview_shortcode' => array(
                    ...
                    'custom_attributes' => array('readonly' => 'readonly'),
                    'default' => '[psb_bnpl_message placement="product"]'
                ),
                ...
                'pay_later_messaging_cart_preview_shortcode' => array(
                    ...
                    'custom_attributes' => array('readonly' => 'readonly'),
                    'default' => '[psb_bnpl_message placement="cart"]'
                ),
                ...
                'pay_later_messaging_payment_preview_shortcode' => array(
                    ...
                    'custom_attributes' => array('readonly' => 'readonly'),
                    'default' => '[psb_bnpl_message placement="payment"]'
            ));
            ...
            $advanced_settings = array(
                ...
                '3d_secure_contingency' => array(
                    'title' => __('Contingency for 3D Secure', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select',
                    'options' => array(
                        'SCA_WHEN_REQUIRED' => __('3D Secure when required', 'smart-paypal-checkout-for-woocommerce'),
                        'SCA_ALWAYS' => __('Always trigger 3D Secure', 'smart-paypal-checkout-for-woocommerce'),
                    ),
                    'default' => 'SCA_WHEN_REQUIRED',
                    'desc_tip' => true,
                    'description' => __('3D Secure benefits cardholders and merchants by providing an additional layer of verification using Verified by Visa, MasterCard SecureCode and American Express SafeKey.', 'smart-paypal-checkout-for-woocommerce'),
                ),
                'paymentaction' => array(
                    'title' => __('Payment action', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select',
                    'description' => __('Choose whether you wish to capture funds immediately or authorize payment only.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => 'capture',
                    'desc_tip' => true,
                    'options' => array(
                ...
                'soft_descriptor' => array(
                    'title' => __('Credit Card Statement Name', 'smart-paypal-checkout-for-woocommerce'),
                    'type' => 'text',
                    'description' => __('The value entered here will be displayed on the buyer\'s credit card statement.', 'smart-paypal-checkout-for-woocommerce'),
                    'default' => '',
                    'desc_tip' => true,
            ...
            $settings = apply_filters('psb_settings', array_merge($default_settings, $button_manager_settings, $pay_later_messaging_settings, $order_review_page_settings, $advanced_settings));
            return $settings;
        }
